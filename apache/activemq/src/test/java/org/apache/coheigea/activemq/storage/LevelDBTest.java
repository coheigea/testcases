 ...
 * under the License.
 */
package org.apache.coheigea.activemq.storage;
...
/**
 * Basic test for message producing + consumer over TCP using LevelDB to store the messages
 */
public class LevelDBTest {
    ...
    public static void startBroker() throws Exception {
        ...
        leveldb.setDirectory(new File("target/activemq-leveldb"));
        broker.setPersistenceAdapter(leveldb);
