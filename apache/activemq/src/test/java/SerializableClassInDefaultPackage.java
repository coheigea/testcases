...
public class SerializableClassInDefaultPackage implements Serializable {
    private static final long serialVersionUID = -7249059185723713380L;
    
    private static volatile boolean readObjectCalled;
...
//        builder.start();
    ...
    public static boolean isReadObjectCalled() {
