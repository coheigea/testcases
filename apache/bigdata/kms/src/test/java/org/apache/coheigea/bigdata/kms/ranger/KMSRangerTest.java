...
public class KMSRangerTest {
    ...
    public void testCreateKey() throws Exception {
        ...
        /*
        when(mock.isACLPresent("***REMOVED***", KeyOpType.MANAGEMENT)).thenReturn(true);
        
        UserGroupInformation u1 = UserGroupInformation.createRemoteUser("u1");
       // when(mock.hasAccessToKey("***REMOVED***", u1, KeyOpType.MANAGEMENT)).thenReturn(true);
            ...
            new PrivilegedExceptionAction<Void>() {
              ...
              public Void run() throws Exception {
                try {
                  ...
                  kpExt.createKey("***REMOVED***", seed, newOptions(conf));
