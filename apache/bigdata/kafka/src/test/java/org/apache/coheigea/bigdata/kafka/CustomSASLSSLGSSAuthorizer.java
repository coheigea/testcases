...
/**
 * A trivial Kafka Authorizer for use with SASL SSL.
 * 
 * The "admin" principal can do anything,
 * The "alice" principal can read/describe/write on the "test*" topics.
 */
public class CustomSASLSSLGSSAuthorizer implements Authorizer {
