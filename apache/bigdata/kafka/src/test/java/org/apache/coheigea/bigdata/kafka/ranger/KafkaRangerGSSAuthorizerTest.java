 ...
 *  - The "public" group can only "read/describe/write" on the "test" topic.
 *  - The "public" group can only "read/describe" on the "dev" topic and not "write".
 *  
 ...
 */
public class KafkaRangerGSSAuthorizerTest {
