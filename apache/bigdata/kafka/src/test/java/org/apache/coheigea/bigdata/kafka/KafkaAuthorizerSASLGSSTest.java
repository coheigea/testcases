 ...
 * Authentication is enforced using SASL Plaintext and GSS.
 * 
 * We also plug in a CustomSASLGSSAuthorizer that enforces some authorization rules.
 */
public class KafkaAuthorizerSASLGSSTest {
