...
public class KerbyServer extends KdcServer {
    ...
    public synchronized void createPrincipal(String principal, String password, String filename)  throws Exception {
        ...
        // Write it out to a keytab
        if (filename != null) {
            String basedir = System.getProperty("basedir");
            if (basedir == null) {
                basedir = new File(".").getCanonicalPath();
            }
            File keytabFile = new File(basedir + "/target/" + filename + ".keytab");
            AdminHelper.exportKeytab(keytabFile, Collections.singletonList(identity));
        }
    }
