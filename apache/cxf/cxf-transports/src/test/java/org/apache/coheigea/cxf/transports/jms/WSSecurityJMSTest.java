 ...
 * under the License.
 */
package org.apache.coheigea.cxf.transports.jms;
...
/**
 * A test-case for a CXF endpoint using the WS-SecurityPolicy Asymmetric Binding over JMS using a queue.
...
public class WSSecurityJMSTest extends AbstractBusClientServerTestBase {
    ...
    public void testAsymmetricOverJMS() throws Exception {
        ...
        URL busFile = WSSecurityJMSTest.class.getResource("cxf-client.xml");
