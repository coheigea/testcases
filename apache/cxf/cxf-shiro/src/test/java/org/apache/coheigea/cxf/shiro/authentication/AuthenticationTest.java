...
/**
 * This tests using Apache Shiro for authentication. A cxf client sends a SOAP UsernameToken to a CXF
 * Endpoint. The CXF Endpoint has been configured (see cxf-service.xml) to validate the UsernameToken
 * via the ShiroUTValidator. A test that passes username/passwords via Basic Authentication to the 
 * CXF endpoint is also added.
 */
