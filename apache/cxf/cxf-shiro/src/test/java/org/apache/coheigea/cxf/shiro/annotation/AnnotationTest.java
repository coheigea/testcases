 ...
 * under the License.
 */
package org.apache.coheigea.cxf.shiro.annotation;
 ...
 * 
 */
public class AnnotationTest extends AbstractBusClientServerTestBase {
    ...
    public void testAuthorizedRequest() throws Exception {
        ...
        URL busFile = AnnotationTest.class.getResource("cxf-client.xml");

        Bus bus = bf.createBus(busFile.toString());
        SpringBusFactory.setDefaultBus(bus);
        SpringBusFactory.setThreadDefaultBus(bus);
        
        URL wsdl = AnnotationTest.class.getResource("DoubleIt.wsdl");
