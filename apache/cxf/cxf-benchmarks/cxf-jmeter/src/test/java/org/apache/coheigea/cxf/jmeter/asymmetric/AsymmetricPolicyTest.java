 ...
 * under the License.
 */
package org.apache.coheigea.cxf.jmeter.asymmetric;
...
public class AsymmetricPolicyTest extends AbstractBusClientServerTestBase {
    ...
    @org.junit.Test
    public void testAsymmetricStreaming() throws Exception {
        ...
        URL wsdl = AsymmetricPolicyTest.class.getResource("DoubleIt.wsdl");
        Service service = Service.create(wsdl, SERVICE_QNAME);
        QName portQName = new QName(NAMESPACE, "DoubleItAsymmetricStreamingPort");
        DoubleItPortType transportPort = 
            service.getPort(portQName, DoubleItPortType.class);
        updateAddressPort(transportPort, PORT);
    ...
    @org.junit.Test
    public void testAsymmetricMTOM() throws Exception {
        ...
        URL wsdl = AsymmetricPolicyTest.class.getResource("DoubleIt.wsdl");
        Service service = Service.create(wsdl, SERVICE_QNAME);
        QName portQName = new QName(NAMESPACE, "DoubleItAsymmetricMtomPort");
        DoubleItPortType transportPort = 
            service.getPort(portQName, DoubleItPortType.class);
        updateAddressPort(transportPort, PORT);
