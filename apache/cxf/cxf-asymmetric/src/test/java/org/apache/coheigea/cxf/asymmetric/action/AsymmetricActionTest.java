 ...
 * under the License.
 */
package org.apache.coheigea.cxf.asymmetric.action;
 ...
 * calls from the client -> service. In all cases, the SOAP Body is signed and encrypted. 
 * 
 ...
 */
public class AsymmetricActionTest extends AbstractBusClientServerTestBase {
    ...
    public void testAsymmetricOAEP() throws Exception {
        ...
        // Endpoint is at:
        // http://localhost:" + PORT + "/doubleit/services/doubleitasymmetricactionoaep
        SpringBusFactory bf = new SpringBusFactory();
        URL busFile = AsymmetricActionTest.class.getResource("cxf-client.xml");

        Bus bus = bf.createBus(busFile.toString());
        SpringBusFactory.setDefaultBus(bus);
        SpringBusFactory.setThreadDefaultBus(bus);
        
        URL wsdl = AsymmetricActionTest.class.getResource("DoubleIt.wsdl");
    ...
    public void testAsymmetricPKCS12() throws Exception {
        ...
        // Endpoint is at:
        // http://localhost:" + PORT + "/doubleit/services/doubleitasymmetricactionpkcs12
        SpringBusFactory bf = new SpringBusFactory();
        URL busFile = AsymmetricActionTest.class.getResource("cxf-client.xml");
    ...
    public void testAsymmetricGCM() throws Exception {
        ...
        // Endpoint is at:
        // http://localhost:" + PORT + "/doubleit/services/doubleitasymmetricactiongcm
        SpringBusFactory bf = new SpringBusFactory();
        URL busFile = AsymmetricActionTest.class.getResource("cxf-client.xml");
