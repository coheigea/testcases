...
public class SyncopeBasicAuthInterceptor extends AbstractPhaseInterceptor<Message> {

    private static final Logger LOG = LogUtils.getL7dLogger(SyncopeBasicAuthInterceptor.class);
    
    private Validator validator;
    
    public SyncopeBasicAuthInterceptor() {
        this(Phase.UNMARSHAL);
    }
    
    public SyncopeBasicAuthInterceptor(String phase) {
        super(phase);
    }
