 ...
 * under the License.
 */
package org.apache.coheigea.camel.ldap;
...
public class LDAPTest extends AbstractLdapTestUnit {
    ...
    public void updatePort() throws Exception {
        if (!portUpdated) {
            ...
            File f = new File(basedir + "/src/test/resources/camel-ldap.xml");
            ...
            File f2 = new File(basedir + "/target/test-classes/camel-ldap.xml");
    ...
    public void testLDAP() throws Exception {
        ...
        Main main = new Main();
        main.setApplicationContextUri("camel-ldap.xml");
