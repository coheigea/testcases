 ...
 * under the License.
 */
package org.apache.coheigea.camel.cxf.proxy.shiro.client;
...
import org.apache.coheigea.camel.cxf.proxy.shiro.service.Server;
...
/**
 * An authorization test using a proxy + Apache Shiro. A CXF JAX-WS "double-it" service requires 
 ...
 * authenticates it to Apache Shiro. Shiro also checks to see that the Subject has the correct role
 * to call the route, which is defined as "boss" in the configuration. On successful authorization, it 
 * passes the call + response to the backend service. 
 */
public class AuthorizationTest extends AbstractBusClientServerTestBase {
    ...
    public static void startServers() throws Exception {
        ...
        main = new Main();
        main.setApplicationContextUri("cxf-proxy-shiro-authz.xml");
        main.start();
    }
