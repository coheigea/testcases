...
/**
 * An authentication test using a proxy + Spring Security. A CXF JAX-WS "double-it" service requires 
 ...
 * authenticates it via Spring Security, and then passes the call + response to the backend service. 
 */
public class AuthenticationTest extends AbstractBusClientServerTestBase {
    ...
    public static void startServers() throws Exception {
        ...
        main = new Main();
        main.setApplicationContextUri("cxf-proxy-spring-security-authn.xml");
        main.start();
    }
