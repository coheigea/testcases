 ...
 * under the License.
 */
package org.apache.coheigea.camel.cxf.utsecureproxy.client;
...
import org.apache.coheigea.camel.cxf.utsecureproxy.service.Server;
...
public class UTSecureProxyTest extends AbstractBusClientServerTestBase {
    ...
    public void testUTSecureProxy() throws Exception {
        ...
        URL wsdl = UTSecureProxyTest.class.getResource("../proxy/DoubleItProxy.wsdl");
